<template>
  <div>
              ...
              <li v-for="item in cartList">
                ...
                <div class="cart-tab-5">
                  <div class="cart-item-opration">
                    <a href="javascript:;" class="item-edit-btn" @click="closeConfirm(item)">
          ...
          <div class="cart-foot-inner">
            <div class="cart-foot-l">
              <div class="item-all-check">
                <a href="javascipt:;" @click="checkedAll">
            ...
            <div class="cart-foot-r">
              ...
              <div class="btn-wrap">
                <a class="btn btn--red" v-bind:class="{'btn--dis':checkedCout==0}" @click="checkOut">Checkout</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <model v-bind:mdshow="mdshow" v-on:close="closeModel">
      ...
      <div slot="btnGroup">
        <a href="javascript:;" class="btn btn--m" @click="deleteConfrim" style="width:150px; margin-right:70px; margin-left:50px">确定</a>
        <a href="javascript:;" class="btn btn--m" @click="closeModel" style="width: 150px;">关闭</a>
      </div>
    </model>
...
<script>
  ...
  export default {
    ...
    computed: {
      checkedAllFlag () {
        return this.checkedCout == this.cartList.length
      },
      checkedCout () {
        let i = 0
