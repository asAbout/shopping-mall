  ...
  <div>
      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item, index) in addressListFilter" v-bind:class="{'check': checkedIndex == index}" @click="checkedIndex=index; addressId = item.addressId">
                  <dl>
                    <dt>{{item.userName}}</dt>
          ...
          <div class="next-btn-wrap">
            <router-link class="btn btn--m btn--red" :to="{path:'orderConfrim', query:{'addressId':addressId}}">Next</router-link>
          </div>
        </div>
      </div>
    </div>
    <model v-bind:mdshow="mdshow" v-on:close="close">
      ...
      <div slot="btnGroup">
        ...
        <a href="javascript:;" class="btn btn--m" @click="mdshow=false" style="width: 150px;">取消</a>
      </div>
    </model>
